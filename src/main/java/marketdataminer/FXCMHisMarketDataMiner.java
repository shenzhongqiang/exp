...
public class FXCMHisMarketDataMiner implements IGenericMessageListener,
     ...
     */
    public FXCMHisMarketDataMiner(String api_url, String connection, String username, String password,
        ...
        if (file == null)
            ...
            this.login = new FXCMLoginProperties(username, password, terminal, api_url);
        else
            this.login = new FXCMLoginProperties(username, password, terminal, api_url, file);
    ...
    public FXCMHisMarketDataMiner(String api_url, String connection, String username, String password,
        ...
        this(api_url, connection, username, password, terminal, basedir, startDate, endDate, null);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.format("%s,%s", api_url, connection);
            //System.exit(0);
            TimeZone tz_ny = TimeZone.getTimeZone("America/New_York");
            Calendar start = new GregorianCalendar(tz_ny);
            Calendar end = (Calendar)start.clone();
            start.add(Calendar.DAY_OF_MONTH, -7);

            FXCMHisMarketDataMiner miner = new FXCMHisMarketDataMiner(api_url, connection,
                user, pwd, "Demo", basedir, start, end);
            miner.login();
